...
describe('Testing prop text values', () => {
  ...
  test('correctly displays username', async () => {
      const {baseElement} = render(<AcceptRejectCard userID="" username={username} badgeId="" badgename="" i1="" i2="" i3="" activitytype="" history="" proof="" />);
      expect (baseElement).toHaveTextContent(username);
  });
  test('correctly displays strength activitytype inputs', async () => {
    const {baseElement} = render(<AcceptRejectCard userID="" username="" badgeId="" badgename="" i1="" i2="" i3="" activitytype="STRENGTH" history="" proof=""/>);
  ...
  test('correctly displays badgename', async () => {
    const {baseElement} = render(<AcceptRejectCard userID="" username="" badgeId="" badgename="badge" i1="" i2="" i3="" activitytype="" history="" proof=""/>);
