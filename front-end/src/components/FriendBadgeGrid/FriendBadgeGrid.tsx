        ...
        <IonGrid >
            <IonRow  className="ion-align-items-center">
                {prop.badges.map(el => 
                    ...
                    <MyBadgeCard key={el.b_id} id={el.b_id.b_id} name={el.b_id.badgename} qty={el.count} badgeEmblem={el.b_id.badgeicon.split('_')[1]} badgeRank={el.b_id.badgeicon.split('_')[0]}></MyBadgeCard>
                    </IonCol>)}
            </IonRow>
        </IonGrid>
        )
